...
- [ ] **Setup ULB VPN**: [ULB VPN Instructions](https://support.ulb.be/fr/web/support/-/comment-utiliser-ulb-vpn-).
- [ ] **Hyperion first connection** with SSH through terminal.
- [ ] **Show JupyterLab**.
- [ ] **Explain URL = SSH address** as well.
- [ ] **Explain the role of each VM**, including builder, and send addresses.
- [ ] **Mention main options to run code**: JupyterLab, screen/tmux.
- [ ] **Quick intro to Singularity containers**.
- [ ] **Show GitHub group page** and add the newcomer's GitHub account as a collaborator to make the private repositories visible.
- [ ] **Share GitHub Pages link** that recapitulates it all.
- [ ] **Show the tricks section** with `htop`, `killall`, `screen`, `getfattr`, …
- [ ] **Do a checkup a few weeks later**.
