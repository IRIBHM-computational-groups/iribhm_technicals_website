...
<Tabs>
<TabItem label="Command Line Interface">
...
| Builder | iribhm-builder.hpda.ulb.ac.be | Dedicated to the construction of containers (a topic well delve into [here](../singularity/)), the Builder server plays a crucial role in crafting environments tailored to your specific needs. Accessible via command line only. | /                                                                   |

</TabItem>
<TabItem label="Jupyter Lab Interface">
